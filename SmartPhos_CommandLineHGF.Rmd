...
knitr::opts_chunk$set(echo = TRUE, dev = c("png","pdf"), fig.path = "./figureCommandLineHGF/")
...
```
```{r heatmapUpdated,fig.width=10, fig.height=8}
g <- p$gtable
...
```{r intensityBoxPlot_specificPhophosite, include=FALSE, eval=FALSE}
...
```{r phosphosites, fig.path = "./figureCommandLineHGF/phosphosites/"}
newSEts <- addZeroTime(newSE, condition = "treatment", treat = "HGF",
                       zeroTreat = "Ctrl",
                       timeRange = c("10min", "20min","40min","100min"))
