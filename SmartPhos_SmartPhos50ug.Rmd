---
title: "SmartPhos: SmartPhos Protocol"
...
```{r}
mae <- readRDS("data/maeTitrationCurve.Rds")
mae <- mae[, mae$tlevel == "T2"]
mae
```
...
```{r}
se <- maeSmartPhos[["Phosphoproteome"]]
colData(se) <- colData(maeSmartPhos)
se
```
...
```{r intensityBoxPlot, include=FALSE, eval=FALSE}
