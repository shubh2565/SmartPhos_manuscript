...
seTitration <- maeSmartPhos[["Phosphoproteome"]]
colData(seTitration) <- colData(maeSmartPhos)

seInSolution <- maeInSol[["Phosphoproteome"]]
colData(seInSolution) <- colData(maeInSol)
```
...
ggsave(filename = "figureDataAnalysisFinal/Fig2_PanelC.pdf",
       plot = fig2_panelC,
       width = 2.9,
       height = 2.9)
```
...
ggsave(filename = "figureDataAnalysisFinal/Fig3_PanelC.pdf",
       plot = fig3_panelC,
       width = 2.9,
       height = 2.9)
...
ggsave(filename = "figureDataAnalysisFinal/Fig2_PanelD.pdf",
       plot = fig2_panelD,
       width = 2.9,
       height = 2.9)
```
...
ggsave(filename = "figureDataAnalysisFinal/Fig3_PanelD.pdf",
       plot = fig3_panelD,
       width = 2.9,
       height = 2.9)
```
