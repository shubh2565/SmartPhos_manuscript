...
ggsave(filename = "figureDataAnalysisFinalFullProteome/Fig3_PanelC.pdf",
       plot = fig3_panelC,
       width = 2.9,
       height = 2.9)
...
rdInSolution5Filter <- rdInSolution50[rdInSolution5$Gene %in% receptors, ]
...
colData(seTitratProcessHGF)$quantity <- fct_relevel(colData(seTitratProcessHGF)$quantity, "5ug", "15ug", "50ug", "200ug", "750ug")

# plotPCAnalysis(pca = pcaTitratHGF, se = seTitratProcessHGF, color = "quantity", 
#                title = "Principal Components (SmartPhos)") + coord_equal() + scale_color_brewer(palette = "Set2") + theme(panel.grid = element_blank(), axis.text  = element_text(color = "black"))

fig2_panelA <- plotPCAnalysis(pca = pcaTitratHGF, se = seTitratProcessHGF, color = "quantity", 
               title = "Principal Components (SmartPhos)")+
  scale_color_brewer(palette = "Set2")+
  labs(title = NULL,
       color = "Protein ug")+
  theme(axis.text.y=element_text(size=6),
...
ggsave(filename = "figureDataAnalysisFinal/Fig2_PanelA.pdf",
       plot = fig2_panelA,
       width = 2.9,
       height = 2.9)
```
